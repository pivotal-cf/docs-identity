...
This repo contains the documentation for Single Sign-On for PCF, which enables users to
...
|-------------| ------|--------|
|**master** | This branch is on staging. ADD ALL NEW 2.0 (or 1.12?) CONTENT to this branch. When 1.11 was released, master and v1.11 were identical. | <a href="https://docs-pcf-staging.cfapps.io/p-identity/1-n/">https://docs-pcf-staging.cfapps.io/p-identity/1-n/</a> |
...
|**1.8** |  **Do not update**. This branch is obsolete. | <a href="https://docs.pivotal.io/p-identity/1-6/">https://docs.pivotal.io/p-identity/1-6/</a>|
|**1.7** |  **Do not update**. This branch is obsolete. | <a href="https://docs.pivotal.io/p-identity/1-6/">https://docs.pivotal.io/p-identity/1-6/</a>|
